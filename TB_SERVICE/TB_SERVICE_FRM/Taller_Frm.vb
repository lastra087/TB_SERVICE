...
Public Class Taller_Frm
    ...
    Private Sub btn_agregar_reparacion_Click(sender As Object, e As EventArgs) Handles btn_agregar_reparacion.Click
    ...
    Private Sub txt_total_repuesto_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles txt_total_repuesto.KeyPress
        e.Handled = True
    End Sub

    Private Sub rdb_cliente_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles rdb_cliente.CheckedChanged
    ...
    Private Sub txt_total_reparacion_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles txt_total_reparacion.KeyPress
        e.Handled = True
    End Sub

    Private Sub btn_calcular_total_Click(sender As System.Object, e As System.EventArgs) Handles btn_calcular_total.Click
    ...
    Private Sub txt_total_final_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles txt_total_final.KeyPress
        e.Handled = True
    End Sub
